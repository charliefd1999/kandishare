...
const ShareHistoryItem: React.FC<ShareHistoryItemProps> = ({ nickname, message, timestamp}) => {
    return (
        <div className="bg-white border rounded-lg shadow h-40 flex flex-col justify-between p-4 m-2">
            <div>
                ...
                <div id="commentBox" className="text-base text-gray-800 overflow-auto max-h-[64px]">
                    {message}
                </div>
            </div>
